...
// TODO: refactor me; use lib method
// see http://bayu.freelancer.web.id/2010/07/16/phpexcel-advanced-read-write-excel-made-simple/
class Import_File_Type_XLSX implements Import_File_Type
{
    ...
    public function import($callback)
    {
        ...
        $this->logger->log('[START] xlsx import', Zend_Log::CRIT);
        ...
        try {
            ...
            $this->logger->log('[END] xlsx import', Zend_Log::CRIT);
            $this->logger->log('XLSX import finished with ' . $this->errors . ' errors', Zend_log::INFO);
            return $success;
        } catch (Exception $e) {
            $this->logger->log($e, Zend_Log::ERR);
            return false;
