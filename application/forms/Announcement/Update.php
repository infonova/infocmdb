...
class Form_Announcement_Update extends Form_AbstractAppForm
{
    public function __construct($translator, $config, $options = null, $announcementId)
    {
        parent::__construct($translator, $options);
        $this->setName('update');
        $this->setAction(APPLICATION_URL . 'announcement/edit/announcementId/' . $announcementId);
        ...
        // re-confirmation
        $re_confirmation = new Zend_Form_Element_Checkbox('re_confirmation');
        $re_confirmation->setLabel('reConfirmation');
        ...
        $this->addElements(array($name, $type, $title_de, $message_de, $title_en, $message_en, $show_from_date, $show_to_date, $valid, $re_confirmation, $submit));
        ...
        $this->getElement('update')->removeDecorator('Label');

        $this->addDecorators(array(
            'FormElements',
            array('HtmlTag', array('tag' => 'table', 'class' => 'update_form')),
            'Form',
        ));
    }
}