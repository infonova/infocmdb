 ...
 *
 */
class Form_Attributegroup_Update extends Form_AbstractAppForm
{
    public function __construct($translator, $attributeGroupList, $attributeGroupConfig, $attributeGroupId)
    {
        parent::__construct($translator, $options);
        $this->setName('create');
        $this->setAttrib('enctype', 'multipart/form-data');
        $this->setAction(APPLICATION_URL . 'attributegroup/edit/attributeGroupId/' . $attributeGroupId);
        ...
        $name->setLabel('name')
            ->setRequired(true)
            ->addValidator(new Form_Validator_UniqueConstraintAttributeGroups())
        ...
        $valid->setDescription($translator->translate('valid_desc'));
        ...
        $this->addElements(array($name, $valid, $parentAttributeGroup, $description,
