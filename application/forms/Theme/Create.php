...
class Form_Theme_Create extends Form_AbstractAppForm
{
    public function __construct($translator, $config)
    {
        ...
        $this->setAction(APPLICATION_URL . 'theme/create');
        ...
        $uniqueValidator = new Form_Validator_UniqueConstraintTheme();
    ...
    public function addSubmitButton()
    {
        ...
        $this->setElementDecorators(array(
            ...
            array(array('data' => 'HtmlTag'), array('tag' => 'td', 'class' => 'element', 'width' => '30%')),
