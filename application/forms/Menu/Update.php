 ...
 *
 */
class Form_Menu_Update extends Form_AbstractAppForm
{
    public function __construct($translator, $config)
    {
        ...
        $cancel->setAttrib('onClick', "javascript:window.location.href='/menu/index';return false;");

        $this->addElements(array($description, $note, $orderNumber, $submit, $cancel));
