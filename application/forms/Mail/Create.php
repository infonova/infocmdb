 ...
 *
 */
class Form_Mail_Create extends Form_AbstractAppForm
{
    ...
    public function __construct($translator, $templates = array(), $options = null)
    {
        ...
        $customRecipients = new Zend_Form_Element_Textarea('customRecipients');
        $customRecipients->setLabel('customRecipients');
        $customRecipients->setAttrib('cols', 30);
        $customRecipients->setAttrib('rows', 5);
        $customRecipients->setAttrib('title', $translator->translate("recipientsHelp"));
        $customRecipients->setAttrib('alt', $translator->translate("recipientsHelp"));
        ...
        $hiddenUser = new Zend_Form_Element_Hidden('user');
        $hiddenUser->clearDecorators();
        $hiddenUser->addDecorator('ViewHelper');
        $this->addElement($hiddenUser);
