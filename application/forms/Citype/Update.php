 ...
 *
 */
class Form_Citype_Update extends Form_AbstractAppForm
{
    private $translator;
    ...
    public function finalizeForm($ciTypeConfig, $fileUploadConfig, $projectList, $maxElements = null)
    {
        ...
        $name->setLabel('name')
            ...
            ->addValidator(new Form_Validator_UniqueConstraintCiTypes());
        ...
        /**
         * <tr>
         * <td id="icon-label"><label for="icon" title="<?php echo $this->translate('citypeIconTitle') ?>" class="optional"><?php echo $this->translate('citypeIconTitle') ?></label></td>
         * <td class="element" style="width: 80%;">
         * <input name="MAX_FILE_SIZE" value="52428800" id="MAX_FILE_SIZE" type="hidden">
         * <input class="standard_button" name="icon" id="icon" type="file">
         * </td>
         * </tr>
         *
         *
