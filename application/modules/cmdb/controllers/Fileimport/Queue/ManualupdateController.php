...
class Fileimport_Queue_ManualupdateController extends AbstractAppAction
{
    ...
    public function indexAction()
    {
        ...
        $dir    = $config->file->import->update->manual->destination;
        ...
        $this->view->filePath  = APPLICATION_URL . '/_uploads/import/update/manual_validation/';
    ...
    public function successAction()
    {
        ...
        $serviceGet = new Service_Fileimport_Get($this->translator, $this->logger, parent::getUserInformation()->getThemeId());
        $paginator  = $serviceGet->getHistorizedItems($page, Service_Fileimport_Get::QUEUE_UPDATE_MANUAL, Service_Fileimport_Get::STATUS_SUCCESS);
    ...
    public function errorAction()
    {
        ...
        $serviceGet = new Service_Fileimport_Get($this->translator, $this->logger, parent::getUserInformation()->getThemeId());
        $paginator  = $serviceGet->getHistorizedItems($page, Service_Fileimport_Get::QUEUE_UPDATE_MANUAL, Service_Fileimport_Get::STATUS_FAILED);
    ...
    public function deleteAction()
    {
        ...
        switch ($status) {
            case 'idle':
                ...
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/manualupdate/');
                break;
            case 'error':
                $serviceDelete->deleteFileImportHistory($historyId);
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/manualupdate/method/error');
                break;
            case 'success':
                $serviceDelete->deleteFileImportHistory($historyId);
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/manualupdate/method/success');
                break;
            default:
                // do nothing
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/manualupdate/');
