...
class Fileimport_Queue_AttributeController extends AbstractAppAction
{
    ...
    public function indexAction()
    {
        ...
        $dir    = $config->file->import->attribute->destination;
        ...
        $this->view->filePath  = APPLICATION_URL . '/_uploads/import/attribute/';
    ...
    public function successAction()
    {
        ...
        $serviceGet = new Service_Fileimport_Get($this->translator, $this->logger, parent::getUserInformation()->getThemeId());
        $paginator  = $serviceGet->getHistorizedItems($page, Service_Fileimport_Get::QUEUE_ATTRIBUTE, Service_Fileimport_Get::STATUS_SUCCESS);
    ...
    public function errorAction()
    {
        ...
        $serviceGet = new Service_Fileimport_Get($this->translator, $this->logger, parent::getUserInformation()->getThemeId());
        $paginator  = $serviceGet->getHistorizedItems($page, Service_Fileimport_Get::QUEUE_ATTRIBUTE, Service_Fileimport_Get::STATUS_FAILED);
    ...
    public function deleteAction()
    {
        ...
        switch ($status) {
            case 'idle':
                ...
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/attribute/');
                break;
            case 'error':
                $serviceDelete->deleteFileImportHistory($historyId);
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/attribute/method/error');
                break;
            case 'success':
                $serviceDelete->deleteFileImportHistory($historyId);
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/attribute/method/success');
                break;
            default:
                // do nothing
                $this->_redirect(APPLICATION_URL . 'fileimport/queue/type/attribute/');
