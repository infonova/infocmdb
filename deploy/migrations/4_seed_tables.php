...
class SeedTables extends AbstractPhinxMigration
{
    ...
    public function up()
    {
        ...
        ");
            ...
            (1, 'new_ci', 'CI anlegen', 'Neues CI erstellen', 'ci/create', 30, '1'),
            (2, 'search', 'Suche', 'Nach CIs suchen', 'search/index', 20, '1'),
            (3, 'user', 'Benutzer', 'Benutzer anzeigen, anlegen, bearbeiten', 'user/index', 100, '1'),
            (4, 'project', 'Projekte', 'Projekte anzeigen, anlegen, bearbeiten', 'project/index', 130, '1'),
            (5, 'role', 'Rollen', 'Rollen anzeigen, anlegen, bearbeiten', 'role/index', 110, '1'),
            (6, 'theme', 'Themen', 'Themen anzeigen, anlegen, bearbeiten', 'theme/index', 120, '1'),
            (7, 'view_type', 'View Types', 'View Types anzeigen, anlegen, bearbeiten', 'attributegroup/index', 70, '1'),
            (8, 'ci_type', 'CI Types', 'CI Type anzeigen, anlegen, bearbeiten', 'citype/index', 40, '1'),
            (9, 'ci_relation_types', 'Relation Types', 'Relation Types anzeigen, anlegen, bearbeiten', 'relationtype/index', 60, '1'),
            (10, 'attribute', 'Attributes', 'Attribute anzeigen, anlegen, bearbeiten', 'attribute/index', 50, '1'),
            (18, 'history', 'History', 'zeigt die History aller CIs an', 'history/index', 90, '1'),
            (19, 'browse_ci', 'Browse Items', 'Strukturierte Anzeige der aktiven CIs', 'index/index', 10, '1'),
            (20, 'auto_discovery', 'Auto Discovery', 'Automatisierte &Auml;nderungen', 'autodiscovery/index', 80, '1'),
            (21, 'search_list', 'Such Listen', 'Such Listen', 'searchlist/index', 125, '1'),
            (22, 'favourites', 'Favoriten', 'Favoriten anzeigen', 'favourites/index', 11, '1'),
            (23, 'mail_config', 'Notifications', 'zur Verwaltung von Mails und Mail Templates', 'mail/index', 255, '1'),
            (24, 'mail_import', 'Mail Import', 'Mail Import', 'mailimport/index', 255, '1'),
            (25, 'customization', 'Customization Modul', 'Customization Modul', 'customization/index', 255, '1'),
            (26, 'reporting', 'Reporting', 'Reporting', 'reporting/index', 255, '1'),
            (27, 'config', 'Configuration', 'Configuration', 'config/index', 150, '1'),
            (28, 'file_import', 'File Import', 'File Import', 'fileimport', 160, '1'),
            (29, 'map', 'Map', 'Map', 'map/index', 21, '1'),
            (30, 'cql_interface', 'CQL-Interface', 'CQL-Interface', 'query/index', 255, '1'),
            (31, 'dashboard', 'Dashboard', 'Dashboard', 'dashboard/index', 12, '1'),
            (32, 'translation', 'Translation Files', 'Translation Files', 'translation/index', 152, '1'),
            (33, 'validation', 'Validation', 'Validierung', 'validation/index', 255, '1'),
            (34, 'menu', 'Menu', 'Menu', 'menu/index', 255, '1'),
            (35, 'logs', 'Log-Files', 'Log-Files', 'log/index', 255, '1'),
            (36, 'workflow', 'Workflow', 'Workflow', 'workflow/index', 255, '1'),
            (37, 'visualization', 'Visualisierung', NULL, 'relation/visualization', 50, '1'),
            (38, 'ticket', 'Tickets', 'Zeigt alle offenen tickets', 'ticket/index', 255, '1'),
            (39, 'event', 'Monitoring Events', NULL, 'event/index', 255, '1'),
            (40, 'attributetype', 'Attribute Type', NULL, 'attributetype/index', 150, '1')
        ");
